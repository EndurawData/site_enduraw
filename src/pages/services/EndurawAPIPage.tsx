          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="group stat-card transform hover:-translate-y-2">
              ...
              <h4 className="text-xl font-bold text-gray-100 mb-4 flex items-center gap-3">
                ...
                {t('servicePages.endurawAPI.weatherModel_title')}
              </h4>
              ...
              <p className="text-paragraph text-gray-200 leading-relaxed">
                {t('servicePages.endurawAPI.weatherModel_p')}
              </p>
            </div>
            ...
            <div className="group stat-card transform hover:-translate-y-2">
              ...
              <h4 className="text-xl font-bold text-gray-100 mb-4 flex items-center gap-3">
                ...
                {t('servicePages.endurawAPI.physioProfile_title')}
              </h4>
              <div className="formula-box">
              ...
              <p className="text-paragraph text-gray-200 leading-relaxed">
                {t('servicePages.endurawAPI.physioProfile_p')}
              </p>
            </div>
            ...
            <div className="group stat-card transform hover:-translate-y-2">
              ...
              <h4 className="text-xl font-bold text-gray-100 mb-4 flex items-center gap-3">
                ...
                {t('servicePages.endurawAPI.equipmentImpact_title')}
              </h4>
              <div className="formula-box">
                <div className="font-mono text-lg text-center text-blue-300 tracking-wide">
              ...
              <p className="text-paragraph text-gray-200 leading-relaxed">
                {t('servicePages.endurawAPI.equipmentImpact_p')}
              </p>
            </div>
            ...
            <div className="group stat-card transform hover:-translate-y-2">
              ...
              <h4 className="text-subtitle text-gradient-blue-light mb-4 flex items-center gap-3">
                ...
                {t('servicePages.endurawAPI.discrepancy_title')}
              </h4>
              <div className="formula-box">
              ...
              <p className="text-paragraph text-gray-200 leading-relaxed">
                {t('servicePages.endurawAPI.discrepancy_p')}
              </p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="glass-card p-8 animate-float-slow">
            <h3 className="text-subtitle text-gradient-blue-light mb-4 uppercase">
              {t('servicePages.endurawAPI.scientificValidation_title')}
            </h3>
            <p className="text-paragraph text-gray-200 leading-relaxed mb-4">
              {t('servicePages.endurawAPI.scientificValidation_p')}
            </p>
            <ul className="text-gray-300 space-y-2">
              <li>• {t('servicePages.endurawAPI.sv_li1')}</li>
              <li>• {t('servicePages.endurawAPI.sv_li2')}</li>
              <li>• {t('servicePages.endurawAPI.sv_li3')}</li>
              <li>• {t('servicePages.endurawAPI.sv_li4')}</li>
            </ul>
          </div>

          <div className="glass-card p-8 animate-float">
            <h3 className="text-subtitle text-gradient-blue-light mb-4 uppercase">
              {t('servicePages.endurawAPI.techIntegration_title')}
            </h3>
            <p className="text-paragraph text-gray-200 leading-relaxed mb-4">
              {t('servicePages.endurawAPI.techIntegration_p')}
            </p>
            <ul className="text-gray-300 space-y-2">
              <li>• {t('servicePages.endurawAPI.ti_li1')}</li>
              <li>• {t('servicePages.endurawAPI.ti_li2')}</li>
              <li>• {t('servicePages.endurawAPI.ti_li3')}</li>
              <li>• {t('servicePages.endurawAPI.ti_li4')}</li>
            </ul>
          </div>
        </div>
      </div>
