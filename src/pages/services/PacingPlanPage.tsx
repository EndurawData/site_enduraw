      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="space-y-12">
          ...
          <div className="glass-card p-8 text-center animate-float">
            <h2 className="text-title-h2 bg-clip-text text-transparent bg-custom-gradient mb-6">{t('servicePages.pacingPlan.experiencePower')}</h2>
          ...
          <div className="glass-card p-8 text-center animate-float">
            <h2 className="text-title-h2 bg-clip-text text-transparent bg-custom-gradient mb-6">{t('servicePages.pacingPlan.readyToOptimize')}</h2>
            <p className="text-paragraph text-gray-200 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="glass-card p-8 animate-float-slow">
              <h3 className="text-subtitle text-gradient-blue-light mb-6">{t('servicePages.pacingPlan.byAnalyzing')}</h3>
              <ul className="space-y-4 text-paragraph text-gray-200">
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full"></div>
                  {t('servicePages.pacingPlan.yourLevel')}
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full"></div>
                  {t('servicePages.pacingPlan.courseProfile')}
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full"></div>
                  {t('servicePages.pacingPlan.envConditions')}
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full"></div>
                  {t('servicePages.pacingPlan.mechanicalDrift')}
                </li>
              </ul>
            </div>

            <div className="glass-card p-8 animate-float">
              <h3 className="text-subtitle text-gradient-blue-light mb-6">{t('servicePages.pacingPlan.weCompute')}</h3>
              <ul className="space-y-4 text-paragraph text-gray-200">
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  {t('servicePages.pacingPlan.finalTime')}
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  {t('servicePages.pacingPlan.pacingPerStation')}
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  {t('servicePages.pacingPlan.weatherAtStations')}
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  {t('servicePages.pacingPlan.splitPace')}
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  {t('servicePages.pacingPlan.whereWhenWalk')}
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  {t('servicePages.pacingPlan.nutritionPlan')}
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="glass-card p-8 text-center">
            <h3 className="text-subtitle text-gradient-blue-light mb-6">{t('servicePages.pacingPlan.learnMoreTech')}</h3>
            <p className="text-paragraph text-gray-200 mb-8">
