    ...
    <div className="pt-16 pb-16 bg-dark-bg text-white font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <section className="mb-10">
          ...
          <a href="mailto:performance@enduraw.co" className="inline-block mt-3 bg-accent hover:bg-accent-light text-white px-6 py-2 rounded-lg font-semibold">Contact us</a>
        </section>
