      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="glass-card p-8 animate-float hover:scale-105 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-bold text-gray-100 mb-4 text-center">{t('contact.performance_title')}</h3>
            <p className="text-paragraph mb-6 text-center leading-relaxed">
              {t('contact.performance_p')}
            </p>
            <a 
          ...
          <div className="glass-card p-8 animate-float-slow hover:scale-105 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-bold text-gray-100 mb-4 text-center">{t('contact.dashboard_title')}</h3>
            <p className="text-paragraph mb-6 text-center leading-relaxed">
              {t('contact.dashboard_p')}
            </p>
            <a 
          ...
          <div className="glass-card p-8 animate-float hover:scale-105 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-bold text-gray-100 mb-4 text-center">{t('contact.communication_title')}</h3>
            <p className="text-paragraph mb-6 text-center leading-relaxed">
              {t('contact.communication_p')}
            </p>
            <a 
