    ...
    <div className="bg-dark-bg text-white min-h-screen pt-16 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <section className="mb-20">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 bg-clip-text text-transparent bg-custom-gradient animate-float-slow">{t('news.followLatest')}</h2>
          <div className="glass-card p-10 animate-float">
            ...
            <p className="text-paragraph text-gray-200 mb-8 leading-relaxed text-center">
              {t('news.instagram_p')}
            </p>
        ...
        <section className="mb-20">
          <h2 className="text-title-h2 bg-clip-text text-transparent bg-custom-gradient mb-12 animate-float">{t('news.dashboardActivities')}</h2>
          <div className="stat-card max-w-4xl mx-auto">
            ...
            <h3 className="text-subtitle text-gradient-blue-light mb-6 text-center">{t('news.recentAnalyses')}</h3>
            <ul className="space-y-4 text-gray-200">
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-[#6CDCFF] rounded-full"></span>
                <span>{t('news.stat1')}</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-[#6CDCFF] rounded-full"></span>
                <span>{t('news.stat2')}</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-[#6CDCFF] rounded-full"></span>
                <span>{t('news.stat3')}</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="w-2 h-2 bg-[#6CDCFF] rounded-full"></span>
                <span>{t('news.stat4')}</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        {/* Latest Content */}
        <section>
          <h2 className="text-title-h2 bg-clip-text text-transparent bg-custom-gradient mb-12 animate-float-slow">{t('news.latestContent')}</h2>
              ...
              <div key={index} className={`glass-card p-8 hover:scale-105 transition-all duration-300 group ${
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <p className="text-paragraph text-gray-200 mb-4 leading-relaxed">{item.description}</p>
                    <span className="inline-flex items-center gap-2 text-[#6CDCFF] font-medium">
