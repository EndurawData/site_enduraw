  ...
  return (
    <div className="bg-dark-bg text-white min-h-screen pt-16 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <section className="mb-20">
          <h2 className="text-title-h2 bg-clip-text text-transparent bg-custom-gradient mb-12 animate-float">Dashboard Activities</h2>
          <div className="stat-card max-w-4xl mx-auto">
            ...
            <h3 className="text-subtitle text-gradient-blue-light mb-6 text-center">Recent Analyses</h3>
